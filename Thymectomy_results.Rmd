...
lessagr <- as_tibble(rbind(c, d, j, k, b, l))
...
lessagr <- lessagr %>% add_row(followup="VATS extended vs. Standard Transsternal ", .before = 1)
lessagr <- lessagr %>% add_row(followup="VATS extended vs. Extended Transsternal", .before = 5)
lessagr <- lessagr %>% add_row(followup="Transcervical-Subxiphoid vs. Standard Transsternal", .before = 13)
lessagr <- lessagr %>% add_row(followup="Extended Transsternal vs. Transcervical-Subxiphoid", .before = 17)
lessagr <- lessagr %>% add_row(followup="Basic Transcervical vs. Extended Transsternal", .before = 21)
