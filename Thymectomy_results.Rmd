...
<details><summary>CLICK To View Main analysis codes</summary>
<p>
...
```{r,  fig.height=4, fig.width=9.5, echo=FALSE, message=FALSE, warning=FALSE}
...
agr <- agr %>% add_row(followup="T3b  vs.  T3a", .before = 1)
agr <- agr %>% add_row(followup="T3b  vs.  T1a", .before = 5)
...
lessagr <- lessagr %>% add_row(followup="T3a  vs.  T2a", .before = 1)
lessagr <- lessagr %>% add_row(followup="T3b  vs.  T2a", .before = 5)
lessagr <- lessagr %>% add_row(followup="T3b  vs.  T2b bi", .before = 13)
lessagr <- lessagr %>% add_row(followup="T3b  vs.  T2b uni", .before = 17)
lessagr <- lessagr %>% add_row(followup="T3a  vs.  T5a", .before = 24)
lessagr <- lessagr %>% add_row(followup="T3b  vs.  T5a", .before = 28)
lessagr <- lessagr %>% add_row(followup="T3b  vs.  T5d", .before = 32)
...
less <- less %>% add_row(followup="T2b uni  vs.  T2b bi", .before = 1)
less <- less %>% add_row(followup="T2a left  vs.  T2a right", .before = 6)
less <- less %>% add_row(followup="T2c  vs.  T2a", .before = 9)
...
**Suppl Figure 1** - The risk of achieving Complete Stable Remission in patients with myasthenia gravis who underwent **T3b**  vs.  those who underwent **T2a** at **3 years of follow-up**
```{r forestplotma40, echo=FALSE, fig.height=3, fig.width=9.5, message=FALSE, warning=FALSE}
...
**Suppl Figure 2** - The risk of achieving Complete Stable Remission in patients with myasthenia gravis who underwent **T3b** vs.  those who underwent **T2a** at **4 years of follow-up**
```{r forestplotma41, echo=FALSE, fig.height=3, fig.width=9.5}
...
**Suppl Figure 3** - The risk of achieving Complete Stable Remission in patients with myasthenia gravis who underwent **T3b** vs.  those who underwent **T2a** at **5 years of follow-up**
```{r forestplotma42, echo=FALSE, fig.height=3, fig.width=9.5}
...
**Suppl Figure 4** - The risk of achieving Complete Stable Remission in patients with myasthenia gravis who underwent **T3b**  vs.  those who underwent **T2a** at **6 years of follow-up**
```{r forestplotma43, echo=FALSE, fig.height=3, fig.width=9.5}
...
**Suppl Figure 5** - The risk of achieving Complete Stable Remission in patients with myasthenia gravis who underwent **T3b** vs.  those who underwent **T2a** at **7 years of follow-up**
...
**Suppl Figure 6** - The risk of achieving Complete Stable Remission in patients with myasthenia gravis who underwent **T3b** vs.  those who underwent **T2a** at **8 years of follow-up**
