...
>[Click here to view full script available in `R Markdown`](https://github.com/ponceoscarj/Thymectomy/blob/master/Thymectomy_results.Rmd)

## Raw data

>[Click here to view the raw data available in `.CSV file`](https://github.com/ponceoscarj/Thymectomy/blob/master/Thymectomy_results.Rmd)


```{r analysis_overall_summary, echo=FALSE}
...
a<- rbind(
  c("T3b  vs.  T3a",  "3 years", ma1[[15]], sum(ma1[[42]]), sum(ma1[[43]]),
    sum(ma1[[44]]),sum(ma1[[45]]), ma1[[25]], expma1[[1]], expma1[[3]], expma1[[4]],
    ma1[[24]]), 
  c("T3b  vs.  T3a",  "4 years", ma2[[15]], sum(ma2[[42]]), sum(ma2[[43]]),
    sum(ma2[[44]]),sum(ma2[[45]]), ma2[[25]], expma2[[1]], expma2[[3]], expma2[[4]],
    ma2[[24]]), 
  c("T3b  vs.  T3a", "5 years", ma3[[15]], sum(ma3[[42]]), sum(ma3[[43]]),
...
```{r,  fig.height=4, fig.width=10.5, echo=FALSE, message=FALSE, warning=FALSE}
...
agr <- agr %>% add_row(followup="T-3b  vs.  T-3a", .before = 1)
agr <- agr %>% add_row(followup="T-3b  vs.  T-1a", .before = 5)
...
```{r,  echo=FALSE, fig.height=9.5, fig.width=10, echo=FALSE, message=FALSE, warning=FALSE}
...
lessagr <- lessagr %>% add_row(followup="T-3a  vs.  T-2a", .before = 1)
lessagr <- lessagr %>% add_row(followup="T-3b  vs.  T-2a", .before = 5)
lessagr <- lessagr %>% add_row(followup="T-3b  vs.  T-2b bi", .before = 13)
lessagr <- lessagr %>% add_row(followup="T-3b  vs.  T-2b uni", .before = 17)
lessagr <- lessagr %>% add_row(followup="T-3a  vs.  T-5a", .before = 24)
lessagr <- lessagr %>% add_row(followup="T-3b  vs.  T-5a", .before = 28)
lessagr <- lessagr %>% add_row(followup="T-3b  vs.  T-5d", .before = 32)
...
```{r,  fig.height=5, fig.width=9.5, echo=FALSE, message=FALSE, warning=FALSE}
...
less <- less %>% add_row(followup="T-2b uni  vs.  T-2b bi", .before = 1)
less <- less %>% add_row(followup="T-2a left  vs.  T-2a right", .before = 6)
less <- less %>% add_row(followup="T-2c  vs.  T-2a", .before = 9)
...
<details><summary> Suppl. Figure 1: T-3b vs. T-3a, risk of CSR at 3 years of follow-up </summary>
<p>
...
<details><summary> Suppl. Figure 2: T-3b vs. T-3a, risk of CSR at 4 years of follow-up </summary>
<p>
...
<details><summary> Suppl. Figure 3: T-3b vs. T-3a, risk of CSR at 4 years of follow-up </summary>
<p>
...
<details><summary> Suppl. Figure 4: T-3b vs. T-2a, risk of CSR at 3 years of follow-up </summary>
<p>
...
<details><summary> Suppl. Figure 5: T-3b vs. T-2a, risk of CSR at 4 years of follow-up </summary>
<p>
...
<details><summary> Suppl. Figure 6: T-3b vs. T-2a, risk of CSR at 5 years of follow-up </summary>
<p>
...
<details><summary> Suppl. Figure 7: T-3b vs. T-2a, risk of CSR at 6 years of follow-up </summary>
<p>
...
<details><summary> Suppl. Figure 8: T-3b vs. T-2a, risk of CSR at 7 years of follow-up </summary>
<p>
...
<details><summary> Suppl. Figure 9: T-3b vs. T-2a, risk of CSR at 8 years of follow-up </summary>
<p>
